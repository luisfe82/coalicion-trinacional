            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Contenido de las Publicaciones de la Organizaciòn
                        ...
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-2">
                                    ...
                                    <input type="hidden" name="idpublica" id="idpublica">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Archivo:</label>
                                <input type="file" class="form-control" name="archivo" id="archivo" maxlength="100"
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <img src="" width="400px" height="120px" id="imagenmuestra">
                            </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/publica.js"></script>
<?php
}
ob_end_flush();
?>