                ...
                <div class="box">
                    <div class="box-header with-border text-center">
                        <h1 class="box-title lead" style="font-size:4rem;">
                            <b>Ayuda :</b><b class="text-primary"> Sección de Publicaciones</b>
                        </h1>
                    </div>
                    <!-- /.box-header -->
                    <!-- centro -->
                    <div class="panel-body" style="text-align: justify;">
                        ...
                        <div class="col-md-10 ">
                            ...
                            <p class="lead">
                                &nbsp;&nbsp;<b>Publicaciones</b> En esta sección del administrador, podra Agregar,Modificar o desactivar cualquier publicación realizada en un archivo pdf de la Coalisión Trinacional.
                                <br><br>
                                &nbsp;&nbsp;Aqui podrá subir todas publicaciones , revistas y folletos, etc. en formato pdf, que la coalición realiza para informar de todas sus acciones y luchas, eventos importantes para la Trinacional.
                                <br><br>
                                &nbsp;&nbsp;<b>NOTA :</b> tambien se explicará la forma en que podrá obtener su link del archivo pdf alojado en su google drive, y asi poderlo mostrar en su página.
                                <br><br>
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="bg-info">link</th>
                                        <th scope="col" class="bg-info">archivo</th>
                                ...
                                <tfoot>
                                    <tr>                                        
                                        ...
                                        <th class="bg-info">Aqui colocaras el link del pdf que se mostrará en la página principal</th>
                                        <th class="bg-info">Aqui colocaras el archivo del pdf que se mostrará en la página principal</th>
                    ...
                    <div class="panel-body" style="text-align: justify;">
                        ...
                        <div class="col-md-12">
                            <?php
                                $titulo = array(
                                    "",
                                    "Area de Trabajo Publicaciones",
                                    "Area de Modificación de Las Publicaciones",
                                    "Como insertar el link de un archivo pdf, contenido en el google drive",
                                    "Sección donde se Mostrará lo capturado",
                                    "Página donde Mostrará el archivo pdf"
                                );
                            ...
                            <hr />
                            <img class="my-2" src="../files/ayuda/publica/Diapositiva<?php echo $i; ?>.JPG" alt=""
