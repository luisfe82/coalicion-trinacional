            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Carousel de la Organizaciòn
                        ...
                        <form name="formulario" id="formulario" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-2">
                                    ...
                                    <input type="hidden" class="form-control" name="idcarousel" id="idcarousel">
                            ...
                            <!-- ══════════════════════════════════════════════════════════════════════════════════════════════════════ -->
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Barra 1 Titulo Español (*):</label>
                                <input type="text" class="form-control" name="barra1" id="barra1" maxlength="200"
                                    placeholder="Escribe contenido aqui..." required
                                    onkeyup="this.value=NumText(this.value)">
                            </div>

                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Barra 1 Titulo Ingles (*):</label>
                                <input type="text" class="form-control" name="enbarra1" id="enbarra1" maxlength="200"
                                    placeholder="Escribe contenido aqui..." required
                                    onkeyup="this.value=NumText(this.value)">
                            </div>
                            <!-- ══════════════════════════════════════════════════════════════════════════════════════════════════════ -->
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Barra 2 Titulo Español (*):</label>
                                <input type="text" class="form-control" name="barra2" id="barra2" maxlength="200"
                                    placeholder="Escribe contenido aqui..." required
                                    onkeyup="this.value=NumText(this.value)">
                            </div>

                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Barra 2 Titulo Ingles (*):</label>
                                <input type="text" class="form-control" name="enbarra2" id="enbarra2" maxlength="200"
                                    placeholder="Escribe contenido aqui..." required
                                    onkeyup="this.value=NumText(this.value)">
                            </div>
                            <!-- ══════════════════════════════════════════════════════════════════════════════════════════════════════ -->
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <img src="" width="220px" height="120px" id="imagenmuestra">
                            </div>

                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Imagen Articulo:</label>
                                <input type="file" class="form-control" name="imagenart" id="imagenart"
                                    accept="image/x-png,image/gif,image/jpeg">
                                <input type="hidden" name="imagenactual2" id="imagenactual2">
                                <img src="" width="120px" height="120px" id="imagenmuestra2">
                            </div>

                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Imagen Lateral:</label>
                                <input type="file" class="form-control" name="imagenlat" id="imagenlat"
                                    accept="image/x-png,image/gif,image/jpeg">
                                <input type="hidden" name="imagenactual3" id="imagenactual3">
                                <img src="" width="120px" height="200px" id="imagenmuestra3">
                            </div>
