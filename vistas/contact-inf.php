                ...
                <div class="row border sombra p-2">
                    ...
                    <div class="col-md-3 bg-light my-3">
                        <div class="contact-info">
                            ...
                            <div class="col-md-12">
                                <img src="../public/img/banderas.png" class="ing-fluid w-100" alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ms-5">                            
                            <form id="main-contact-form" class="contact-form" name="contact-form" action="contact-mex.php" method="POST">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="hidden" required name="para" value="<?php echo $lang['temail2'] ?>" placeholder="" id="para" required="">
