                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <div class="d-flex justify-content-between ">
                                                        <p class="card-text lead text-small">
                                                            <i><?php echo $articulo[$solida[$i]]['pais'] ?> -
                                                                <?php echo $articulo[$solida[$i]]['fecha'] ?>
                                                        </p></i>
                                                        <p><a class="bg-boton px-2"
                                                                href="articulo.php?id=<?php echo $solida[$i] ?>&<?php echo str_replace(' ','-',$articulo[$solida[$i]]['titulo']); ?>">
